                                ...
                                <div className="row g-4 align-items-center">
                                    ...
                                    <div className="col-auto d-flex">
                                        <select className="form-select me-3">
                                            <option value="">7 October, 2021</option>
                                        </select><a href="#" className="btn btn-primary">Export</a></div>
                                </div>
                            </div>
                                    ...
                                    <div className="card saw-indicator flex-grow-1"
                                        ...
                                        <div className="sa-widget-header saw-indicator__header">
                                            ...
                                            <div className="sa-widget-header__actions">
                                                <div className="dropdown"><button type="button"
                                                    className="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-1"
                                        ...
                                        <div className="saw-indicator__body">
                                            ...
                                            <div className="saw-indicator__delta saw-indicator__delta--rise">
                                                <div className="saw-indicator__delta-direction"><svg
                                ...
                                <div className="col-12 col-md-4 d-flex">
                                    <div className="card saw-indicator flex-grow-1"
                                        ...
                                        <div className="sa-widget-header saw-indicator__header">
                                            ...
                                            <div className="sa-widget-header__actions">
                                                <div className="dropdown"><button type="button"
                                                    className="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-2"
                                                    data-bs-toggle="dropdown" aria-expanded="false" aria-label="More"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="3" height="13"
                                                        fill="currentColor">
                                                        <path
                                ...
                                <div className="col-12 col-md-4 d-flex">
                                    <div className="card saw-indicator flex-grow-1"
                                        ...
                                        <div className="sa-widget-header saw-indicator__header">
                                            ...
                                            <div className="sa-widget-header__actions">
                                                <div className="dropdown"><button type="button"
                                                    className="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-3"
                                                    data-bs-toggle="dropdown" aria-expanded="false" aria-label="More"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="3" height="13"
                                                        fill="currentColor">
                                                        <path
                                ...
                                <div className="col-12 col-lg-4 col-xxl-3 d-flex">
                                    <div className="card flex-grow-1 saw-pulse"
                                        ...
                                        <div className="sa-widget-header saw-pulse__header">
                                            ...
                                            <div className="sa-widget-header__actions">
                                                <div className="dropdown"><button type="button"
                                                    className="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-4"
                                                    data-bs-toggle="dropdown" aria-expanded="false" aria-label="More"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="3" height="13"
                                                        fill="currentColor">
                                                        <path
                                ...
                                <div className="col-12 col-lg-8 col-xxl-9 d-flex">
                                    <div className="card flex-grow-1 saw-chart"
                                        ...
                                        <div className="sa-widget-header saw-chart__header">
                                            ...
                                            <div className="sa-widget-header__actions">
                                                <div className="dropdown"><button type="button"
                                                    className="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-5"
                                                    data-bs-toggle="dropdown" aria-expanded="false" aria-label="More"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="3" height="13"
                                                        fill="currentColor">
                                                        <path
                                        ...
                                        <div className="saw-chart__body">
                                            <div className="saw-chart__container"><canvas></canvas></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-xxl-9 d-flex">
                                    <div className="card flex-grow-1 saw-table">
                                        <div className="sa-widget-header saw-table__header">
                                            ...
                                            <div className="sa-widget-header__actions">
                                                <div className="dropdown"><button type="button"
                                                    className="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-6"
                                                    data-bs-toggle="dropdown" aria-expanded="false" aria-label="More"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="3" height="13"
                                                        fill="currentColor">
                                                        <path
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div className="d-flex align-items-center"><a href="app-customer.html"
                                ...
                                <div className="col-12 col-xxl-3 d-flex">
                                    <div className="card flex-grow-1 saw-chart-circle"
                                        ...
                                        <div className="sa-widget-header saw-chart-circle__header">
                                            ...
                                            <div className="sa-widget-header__actions">
                                                <div className="dropdown"><button type="button"
                                                    className="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-7"
                                                    data-bs-toggle="dropdown" aria-expanded="false" aria-label="More"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="3" height="13"
                                                        fill="currentColor">
                                                        <path
                                        ...
                                        <div className="saw-chart-circle__body">
                                            <div className="saw-chart-circle__container"><canvas></canvas></div>
                                        </div>
                                    ...
                                    <div className="card flex-grow-1">
                                        <div className="card-body">
                                            <div className="sa-widget-header mb-4">
                                                ...
                                                <div className="sa-widget-header__actions">
                                                    <div className="dropdown"><button type="button"
                                                        className="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-8"
                                    ...
                                    <div className="card flex-grow-1">
                                        <div className="card-body">
                                            <div className="sa-widget-header">
                                                ...
                                                <div className="sa-widget-header__actions">
                                                    <div className="dropdown"><button type="button"
                                                        className="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-9"
                                                        data-bs-toggle="dropdown" aria-expanded="false"
                                                        aria-label="More"><svg xmlns="http://www.w3.org/2000/svg" width="3"
                                                            height="13" fill="currentColor">
                                                            <path
                                        ...
                                        <ul className="list-group list-group-flush">
                                            <li className="list-group-item py-2">
                                                <div className="d-flex align-items-center py-3"><a href="app-product.html"
                                                    className="me-4">
                                                    ...
                                                    <div className="d-flex align-items-center flex-grow-1 flex-wrap">
                                                        <div className="col"><a href="app-product.html"
                                                            className="text-reset fs-exact-14">Wiper Blades Brandix WL2</a>
                                                            <div className="text-muted fs-exact-13">Reviewed by <a
                                                                href="app-customer.html" className="text-reset">Ryan Ford</a>
                                                            </div>
                                                        </div>
                                            ...
                                            <li className="list-group-item py-2">
                                                <div className="d-flex align-items-center py-3"><a href="app-product.html"
                                                    ...
                                                    <div className="d-flex align-items-center flex-grow-1 flex-wrap">
                                                        <div className="col"><a href="app-product.html"
                                                            className="text-reset fs-exact-14">Electric Planer Brandix KL370090G
                                                            300 Watts</a>
                                                            <div className="text-muted fs-exact-13">Reviewed by <a
                                                                href="app-customer.html" className="text-reset">Adam Taylor</a>
                                                            </div>
                                                        </div>
                                                        <div className="col-12 col-sm-auto">
                                                            <div className="sa-rating ms-sm-3 my-2 my-sm-0">
                                            ...
                                            <li className="list-group-item py-2">
                                                <div className="d-flex align-items-center py-3"><a href="app-product.html"
                                                    ...
                                                    <div className="d-flex align-items-center flex-grow-1 flex-wrap">
                                                        <div className="col"><a href="app-product.html"
                                                            className="text-reset fs-exact-14">Water Tap</a>
                                                            <div className="text-muted fs-exact-13">Reviewed by <a
                                                                href="app-customer.html" className="text-reset">Jessica
                                                                Moore</a></div>
                                                        </div>
                                                        <div className="col-12 col-sm-auto">
                                                            <div className="sa-rating ms-sm-3 my-2 my-sm-0">
                                            ...
                                            <li className="list-group-item py-2">
                                                <div className="d-flex align-items-center py-3"><a href="app-product.html"
                                                    ...
                                                    <div className="d-flex align-items-center flex-grow-1 flex-wrap">
                                                        <div className="col"><a href="app-product.html"
                                                            className="text-reset fs-exact-14">Brandix Router Power Tool
                                                            2017ERXPK</a>
                                                            <div className="text-muted fs-exact-13">Reviewed by <a
                                                                href="app-customer.html" className="text-reset">Helena
                                                                Garcia</a></div>
                                                        </div>
                                                        <div className="col-12 col-sm-auto">
                                                            <div className="sa-rating ms-sm-3 my-2 my-sm-0">
                                            ...
                                            <li className="list-group-item py-2">
                                                <div className="d-flex align-items-center py-3"><a href="app-product.html"
                                                    ...
                                                    <div className="d-flex align-items-center flex-grow-1 flex-wrap">
                                                        <div className="col"><a href="app-product.html"
                                                            className="text-reset fs-exact-14">Undefined Tool IRadix DPS3000SY
                                                            2700 Watts</a>
                                                            <div className="text-muted fs-exact-13">Reviewed by <a
                                                                href="app-customer.html" className="text-reset">Ryan Ford</a>
                                                            </div>
                                            ...
                                            <li className="list-group-item py-2">
                                                <div className="d-flex align-items-center py-3"><a href="app-product.html"
                                                    ...
                                                    <div className="d-flex align-items-center flex-grow-1 flex-wrap">
                                                        <div className="col"><a href="app-product.html"
                                                            className="text-reset fs-exact-14">Brandix Screwdriver SCREW150</a>
                                                            <div className="text-muted fs-exact-13">Reviewed by <a
                                                                href="app-customer.html" className="text-reset">Charlotte
                                                                Jones</a></div>
                                                        </div>
                                                        <div className="col-12 col-sm-auto">
                                                            <div className="sa-rating ms-sm-3 my-2 my-sm-0">
