        ...
        <div className="sa-app sa-app--desktop-sidebar-shown sa-app--mobile-sidebar-hidden sa-app--toolbar-fixed">
            <div className="sa-app__sidebar">
                <div className="sa-sidebar">
                    <div className="sa-sidebar__header"><a className="sa-sidebar__logo" href="index-2.html">
                        <div className="sa-sidebar-logo"><svg xmlns="http://www.w3.org/2000/svg" width="120px"
                            height="20px">
                            <path
                        ...
                        <ul className="sa-nav sa-nav--sidebar" data-sa-collapse="">
                            <li className="sa-nav__section">
                                ...
                                <ul className="sa-nav__menu sa-nav__menu--root">
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"><a href="index-2.html"
                                        className="sa-nav__link"><span className="sa-nav__icon"><svg
                                        ...
                                        </svg></span><span className="sa-nav__title">Dashboard</span></a></li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" className="sa-nav__link"
                                            data-sa-collapse-trigger=""><span className="sa-nav__icon"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                viewBox="0 0 16 16" fill="currentColor">
                                                <path
                                            ...
                                            </svg></span><span className="sa-nav__title">Catalog</span><span
                                                className="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6"
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" className="sa-nav__link"
                                            ...
                                            </svg></span><span className="sa-nav__title">Customers</span><span
                                                className="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6"
                                                    height="9" viewBox="0 0 6 9" fill="currentColor">
                                                    <path
                                                        d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" className="sa-nav__link"
                                            ...
                                            </svg></span><span className="sa-nav__title">Orders</span><span
                                                className="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6"
                                                    height="9" viewBox="0 0 6 9" fill="currentColor">
                                                    <path
                                                        d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" className="sa-nav__link"
                                            ...
                                            </svg></span><span className="sa-nav__title">Marketing</span><span
                                                className="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6"
                                                    height="9" viewBox="0 0 6 9" fill="currentColor">
                                                    <path
                                                        d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" className="sa-nav__link"
                                            data-sa-collapse-trigger=""><span className="sa-nav__icon"><i
                                                className="fas fa-envelope"></i></span><span
                                                    className="sa-nav__title">Inbox</span><span className="sa-nav__arrow"><svg
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"><a href="app-analytics.html"
                                        className="sa-nav__link"><span className="sa-nav__icon"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                            viewBox="0 0 16 16" fill="currentColor">
                                            <path
                                        ...
                                        </svg></span><span className="sa-nav__title">Analytics</span></a></li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" className="sa-nav__link"
                                            data-sa-collapse-trigger=""><span className="sa-nav__icon"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                            ...
                                            </svg></span><span className="sa-nav__title">Settings</span><span
                                                className="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6"
                                                    height="9" viewBox="0 0 6 9" fill="currentColor">
                                                    <path
                                                        d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                            ...
                            <li className="sa-nav__section">
                                ...
                                <ul className="sa-nav__menu sa-nav__menu--root">
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" className="sa-nav__link"
                                            data-sa-collapse-trigger=""><span className="sa-nav__icon"><i
                                                className="fas fa-lock"></i></span><span
                                                    className="sa-nav__title">Authentication</span><span className="sa-nav__arrow"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                                        viewBox="0 0 6 9" fill="currentColor">
                                                        <path
                                                            d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" className="sa-nav__link"
                                            data-sa-collapse-trigger=""><span className="sa-nav__icon"><i
                                                className="fas fa-bars"></i></span><span className="sa-nav__title">Menu Level
                                                    0</span><span className="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <ul className="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                            <li className="sa-nav__menu-item" data-sa-collapse-item="sa-nav__menu-item--open"><a
                                                href="#" className="sa-nav__link" data-sa-collapse-trigger=""><span
                                                    className="sa-nav__menu-item-padding"></span><span
                                                        className="sa-nav__title">Menu Level 1</span><span
                                                            className="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                                                width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                                        <path
                                                            d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                                        </path>
                                                ...
                                                <ul className="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                                    <li className="sa-nav__menu-item"
                                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#"
                                                            className="sa-nav__link" data-sa-collapse-trigger=""><span
                                                                className="sa-nav__menu-item-padding"></span><span
                                                                    className="sa-nav__menu-item-padding"></span><span
                                                                        className="sa-nav__title">Menu Level 2</span><span
                                                                            className="sa-nav__arrow"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                                                                viewBox="0 0 6 9" fill="currentColor">
                                                                    <path
                                                                        d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                            ...
                            <li className="sa-nav__section">
                                ...
                                <ul className="sa-nav__menu sa-nav__menu--root">
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" className="sa-nav__link"
                                            data-sa-collapse-trigger=""><span className="sa-nav__icon"><i
                                                className="fas fa-compass"></i></span><span
                                                    className="sa-nav__title">Components</span><span className="sa-nav__arrow"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                                        viewBox="0 0 6 9" fill="currentColor">
                                                        <path
                                                            d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" className="sa-nav__link"
                                            data-sa-collapse-trigger=""><span className="sa-nav__icon"><i
                                                className="fas fa-toggle-on"></i></span><span
                                                    className="sa-nav__title">Forms</span><span className="sa-nav__arrow"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                                        viewBox="0 0 6 9" fill="currentColor">
                                                        <path
                                                            d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                        data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" className="sa-nav__link"
                                            data-sa-collapse-trigger=""><span className="sa-nav__icon"><i
                                                className="fas fa-table"></i></span><span
                                                    className="sa-nav__title">Tables</span><span className="sa-nav__arrow"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                                        viewBox="0 0 6 9" fill="currentColor">
                                                        <path
                                                            d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
            ...
            <div className="sa-app__content">
                <div className="sa-toolbar sa-toolbar--search-hidden sa-app__toolbar">
                    <div className="sa-toolbar__body">
                        <div className="sa-toolbar__item"><button className="sa-toolbar__button" type="button" aria-label="Menu"
                        ...
                        <div className="sa-toolbar__item sa-toolbar__item--search">
                            <form className="sa-search sa-search--state--pending">
                                <div className="sa-search__body"><label className="visually-hidden" for="input-search">Search
                                    for:</label>
                                    <div className="sa-search__icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                    ...
                                    </svg></div><input type="text" id="input-search" className="sa-search__input"
                                        placeholder="Search for the truth" autoComplete="off" /><button
                                            className="sa-search__cancel d-sm-none" type="button" aria-label="Close search"><svg
                        ...
                        <div className="sa-toolbar__item d-sm-none"><button className="sa-toolbar__button" type="button"
                        ...
                        <div className="sa-toolbar__item dropdown"><button className="sa-toolbar__button" type="button"
                            ...
                            data-bs-offset="0,1" aria-expanded="false"><img src="vendor/flag-icons/24/DE.png"
                                className="sa-language-icon" alt="" /></button>
                            ...
                            <div className="dropdown-menu dropdown-menu-end py-0" aria-labelledby="dropdownMenuButton2">
                                <div className="sa-notifications">
                                    <div className="sa-notifications__header">
                                        <div className="sa-notifications__header-title">Notifications</div><a
                                            className="sa-notifications__header-action" href="#">Mark All as Read</a>
                                    </div>
                                    <ul className="sa-notifications__list">
                                        <li className="sa-notifications__item"><a href="#"
                                            className="sa-notifications__item-button">
                                            <div className="sa-notifications__item-icon">
                                                <div
                                                    className="sa-symbol sa-symbol--shape--rounded sa-symbol--style--primary">
                                                    <div className="sa-symbol__icon"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="dropdown sa-toolbar__item"><button className="sa-toolbar-user" type="button"
                            id="dropdownMenuButton" data-bs-toggle="dropdown" data-bs-offset="0,1"
                            aria-expanded="false"><span
                                className="sa-toolbar-user__avatar sa-symbol sa-symbol--shape--rounded"><img
                                    src="images/customers/customer-4-64x64.jpg" width="64" height="64"
                                    alt="" /></span><span className="sa-toolbar-user__info"><span
                                        className="sa-toolbar-user__title">Konstantin Veselovsky</span><span
                                            className="sa-toolbar-user__subtitle">stroyka@example.com</span></span></button>
                        ...
                        <div className="container">
                            <div className="py-5">
                                <div className="row g-4 align-items-center">
                                    <div className="col">
                                        <nav className="mb-2" aria-label="breadcrumb">
                                            <ol className="breadcrumb breadcrumb-sa-simple">
                                                <li className="breadcrumb-item"><a href="index-2.html">Dashboard</a></li>
                                                <li className="breadcrumb-item"><a href="app-products-list.html">Products</a>
                                                </li>
                                    ...
                                    <div className="col-auto d-flex"><a href="#" className="btn btn-secondary me-3">Duplicate</a><a
                                        href="#" className="btn btn-primary">Save</a></div>
                                </div>
                            </div>
                                    ...
                                    <div className="sa-entity-layout__main">
                                        <div className="card">
                                            <div className="card-body p-5">
                                                ...
                                                <div className="mb-4"><label for="form-product/name"
                                                    className="form-label">Name</label><input type="text"
                                                        className="form-control" id="form-product/name"
                                                        value="Brandix Screwdriver SCREW150" /></div>
                                                <div className="mb-4"><label for="form-product/slug"
                                                    className="form-label">Slug</label>
                                                    <div className="input-group input-group--sa-slug"><span
                                                        className="input-group-text"
                                                        id="form-product/slug-addon">https://example.com/products/</span><input
                                                            type="text" className="form-control" id="form-product/slug"
                                                            aria-describedby="form-product/slug-addon form-product/slug-help"
                                                            value="brandix-screwdriver-screw150" /></div>
                                                    <div id="form-product/slug-help" className="form-text">Unique human-readable
                                                        product identifier. No longer than 255 characters.</div>
                                                </div>
                                                <div className="mb-4"><label for="form-product/description"
                                                    className="form-label">Description</label><textarea
                                                        id="form-product/description" className="sa-quill-control form-control"
                                                ...
                                                <div><label for="form-product/short-description" className="form-label">Short
                                                    description</label><textarea id="form-product/short-description"
                                                        className="form-control" rows="2"></textarea></div>
                                            </div>
                                        </div>
                                        <div className="card mt-5">
                                            <div className="card-body p-5">
                                                ...
                                                <div className="row g-4">
                                                    <div className="col"><label for="form-product/price"
                                                        className="form-label">Price</label><input type="number"
                                                            className="form-control" id="form-product/price" value="1499" />
                                                    </div>
                                                    <div className="col"><label for="form-product/old-price"
                                                        className="form-label">Old price</label><input type="number"
                                                            className="form-control" id="form-product/old-price" /></div>
                                                </div>
                                                <div className="mt-4 mb-n2"><a href="#">Schedule discount</a></div>
                                            </div>
                                        </div>
                                        <div className="card mt-5">
                                            <div className="card-body p-5">
                                                ...
                                                <div className="mb-4"><label for="form-product/sku"
                                                    className="form-label">SKU</label><input type="text"
                                                        className="form-control" id="form-product/sku" value="SCREW150" /></div>
                                                <div className="mb-4 pt-2"><label className="form-check"><input type="checkbox"
                                                    className="form-check-input" /><span className="form-check-label">Enable
                                                        stock management</span></label></div>
                                                <div><label for="form-product/quantity" className="form-label">Stock
                                                    quantity</label><input type="number" className="form-control"
                                        ...
                                        <div className="card mt-5">
                                            ...
                                            <div className="mt-n5">
                                                    ...
                                                    <table className="sa-table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div
                                                                        className="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                                ...
                                                                <td><input type="number"
                                                                    ...
                                                                    value="0" /></td>
                                                                <td><button className="btn btn-sa-muted btn-sm mx-n3"
                                                ...
                                                <div className="sa-divider"></div>
                                                <div className="px-5 py-4 my-2"><a href="#">Upload new image</a></div>
                                            </div>
                                        </div>
                                        <div className="card mt-5">
                                            <div className="card-body p-5">
                                                <div className="mb-5">
                                                    <h2 className="mb-0 fs-exact-18">Search engine optimization</h2>
                                                    <div className="mt-3 text-muted">Provide information that will help improve
                                                        the snippet and bring your product to the top of search engines.
                                                    </div>
                                                </div>
                                                <div className="mb-4"><label for="form-product/seo-title"
                                                    className="form-label">Page title</label><input type="text"
                                                        className="form-control" id="form-product/seo-title" /></div>
                                                <div><label for="form-product/seo-description" className="form-label">Meta
                                    ...
                                    <div className="sa-entity-layout__sidebar">
                                        <div className="card w-100">
                                            <div className="card-body p-5">
                                                ...
                                                <div className="mb-4"><label className="form-check"><input type="radio"
                                                    className="form-check-input" name="status" /><span
                                                        className="form-check-label">Published</span></label><label
                                                            className="form-check"><input type="radio" className="form-check-input"
                                                                name="status" checked="" /><span
                                                                    className="form-check-label">Scheduled</span></label><label
                                                                        className="form-check mb-0"><input type="radio" className="form-check-input"
                                                                            name="status" /><span
                                                                                className="form-check-label">Hidden</span></label></div>
                                                <div><label for="form-product/seo-title" className="form-label">Publish
                                                    date</label><input type="text" className="form-control datepicker-here"
                                        ...
                                        <div className="card w-100 mt-5">
                                            <div className="card-body p-5">
                                                ...
                                                </div><select className="sa-select2 form-select" multiple="">
                                        ...
                                        <div className="card w-100 mt-5">
                                            <div className="card-body p-5">
                                                ...
                                                </div><select className="sa-select2 form-select" data-tags="true" multiple="">
                ...
                <div className="sa-app__footer d-block d-md-flex">Stroyka Admin — eCommerce Dashboard Template
                    © 2021<div className="m-auto"></div>
                    <div>Powered by HTML — Design by <a href="https://themeforest.net/user/kos9/portfolio">Kos</a></div>
                </div>
            </div>
            <div className="sa-app__toasts toast-container bottom-0 end-0"></div>
        </div>
    )
}
