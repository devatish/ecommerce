...
(function ($, window) {
    ...
    */
    ...
    // Collapse
    */
    $(document).on('click', '[data-sa-collapse-trigger]', function (event) {
        event.preventDefault();
        const collapse = $(this).closest('[data-sa-collapse]');
    ...
    */
    window.stroyka.layoutSidebar = (function () {
        ...
        /*$(document).on('click','[data-sa-layout-sidebar-open]', function () {
            window.stroyka.layoutSidebar.open();
        });
        $(document).on('click','[data-sa-layout-sidebar-close]', function () {
            window.stroyka.layoutSidebar.close();
        });*/
